...
//5. Define functions which trigger the events   
...
//2. Define the UI places where the action will fire with JSX

    var studentName;
    var questions;

//4. Handle with the state and HTML UI.
...
//3. Return the elements where the action will be displayed
